...
class CreateProductEndToEnd extends InternalApiTestCase
{
    protected function setUp(): void
    {
        parent::setUp();

        $admin = self::$container->get('pim_user.repository.user')->findOneByIdentifier('admin');
    ...
    public function test_it_downloads_a_pdf_for_a_product_with_an_image(): void
    {
        ...
        $this->client->request('GET', "/enrich/product/{$product->getId()}/download-pdf?dataLocale=en_US&dataScope=ecommerce");
